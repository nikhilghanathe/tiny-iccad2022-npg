...
def main():
    ...
    for idx in tqdm(range(0, len(List))):
        ...
        testX = txt_to_numpy(args.path_data + List[idx].split(',')[1].strip(), 1250).reshape(1, 1250, 1, 1)
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--com', type=str, default='COM4')
